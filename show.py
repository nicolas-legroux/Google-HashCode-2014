...
# INF580 Programmation par contraintes et programmation mathÃ©matiques
# devoir maison
...
class Instance:
    ...
    def __init__(self, filename):
        ...
        # pour chaque arc a:
        self.dist = {} # dist[a]   mÃ¨tres de la rue
        self.temp = {} # temps=[a] sec nÃ©cessaire Ã  la traversÃ©e
    ...
    def random(self):
        ...
        while veh:
            # prochain vÃ©hicule
            T, i, a = heappop(veh)
            # prÃ©parer liste des possibilitÃ©s
    ...
    def write_gpx(self, filename, veh = None):
        "veh permet de spÃ©cifier un vÃ©hicule dont le tour seul doit Ãªtre exportÃ©."
        fi = open(filename, 'w')
...
if __name__=="__main__":
    ...
    if len(argv)==2:
        ...
        G.write_gpx( out )
        print ("Un fichier '%s' a Ã©tÃ© produit que vous pouvez importer dans http://umap.openstreetmap.co/fr/" % out)
    else:
        print("""\
Usage: ./devoirMaison.py paris_54000.txt  # pour lire l'instance et produire une solution alÃ©atoire
